  ...
  module Charts
    module Components
      class BookedCard < BaseCard
        ...
        def render
          <<-HTML.html_safe
            <div class="booking-card #{'dayoff' if @is_workday == 'dayoff'} #{'ending' if @issue && @issue.due_date == @date} booking">
              ...
              <div class="description-box#{'-dayoff' if @is_workday == 'dayoff'}" style="height: #{@description_box_height}em;">
                <div class="text-box">
                  #{@description}
                </div>
              </div>
        ...
        def small_block_render
          <<-HTML.html_safe
            <div class="small-booking-card editable booking tooltip" edit_url="#{edit_path_for(@resource_booking)}">
              <span class="tip issue-spent">
                #{render_resource_booking_tooltip(@resource_booking)}
              </span>
